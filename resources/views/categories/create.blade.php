                                ...
                                <div class="col-12">
                                    <div class="alert alert-info mb-0">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h4 class="alert-title">About Slug</h4>
                                                <div class="text-muted">The slug is automatically generated from the category name. It's used in URLs and should be unique.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
