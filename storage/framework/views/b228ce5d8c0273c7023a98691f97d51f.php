    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="<?php echo e(url('/')); ?>" class="d-flex align-items-center">
                <img src="<?php echo e(asset('static/logo.svg')); ?>" width="32" height="32" alt="NexoraLabs" class="navbar-brand-image me-2">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm shadow-none"
                          style="background-image: url(<?php echo e(Avatar::create(Auth::user()->name)->toBase64()); ?>)">
                    </span>
...
<?php /**PATH C:\xampp\htdocs\New folder\NexoraLabs\resources\views/layouts/body/header.blade.php ENDPATH**/ ?>