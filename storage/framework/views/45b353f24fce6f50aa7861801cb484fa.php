...
<?php endif; ?>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('jobs.index')); ?>" class="btn btn-outline-primary" title="Create Job">
                            ...
                            <a href="<?php echo e(route('returns.create')); ?>" class="btn btn-outline-warning" title="Create Return">
                            ...
                            <a href="<?php echo e(route('expenses.create')); ?>" class="btn btn-outline-danger" title="Record Expense">
            ...
            <form id="order-form" action="<?php echo e(route('orders.store')); ?>" method="POST">
                ...
                <input name="date" id="date" type="hidden" value="<?php echo e(now()->format('Y-m-d')); ?>">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="flex-1" style="overflow-y: auto; overflow-x: hidden; max-height: 500px;">
                                    <h4 class="mb-3">Products (<span id="products-count"><?php echo e($products_count ?? safe_count($products)); ?></span> items)</h4>
                                    <div id="products-grid" class="row g-2" style="margin: 0;">
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6 col-lg-4" style="padding: 0.25rem;">
                                                <div class="card product-card <?php echo e($product->quantity <= 0 ? 'out-of-stock' : 'cursor-pointer hover-shadow'); ?>"
                                                    data-product-id="<?php echo e($product->id); ?>"
                                                    data-stock="<?php echo e($product->quantity); ?>"
                                                    data-warranty-id="<?php echo e($product->warranty_id ?? ''); ?>"
                                                    data-warranty-name="<?php echo e($product->warranty ? $product->warranty->name : ''); ?>"
                                                    data-warranty-duration="<?php echo e($product->warranty ? $product->warranty->duration : ''); ?>"
                                                    style="border: <?php echo e($product->quantity <= 0 ? '2px solid #ef4444' : '1px solid #e9ecef'); ?>;
                                                    border-radius: 8px;
                                                    min-height: 50px;
                                                    width: 100%;
                                                    <?php echo e($product->quantity <= 0 ? 'opacity: 0.6; cursor: not-allowed;' : ''); ?>">
                                                    <div class="card-body p-3">
                                                        <div class="text-start">
                                                            <div class="fw-bold <?php echo e($product->quantity <= 0 ? 'text-muted' : 'text-dark'); ?> mb-1"
                                                            ...
                                                            <div class="text-muted small mb-2" style="font-size: 11px;">
                                                                PRD-<?php echo e(str_pad($product->id, 6, '0', STR_PAD_LEFT)); ?>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center"
                                                            ...
                                                            <span
                                                                class="fw-bold <?php echo e($product->quantity <= 0 ? 'text-muted' : 'text-success'); ?>"
                                                            ...
                                                            <?php if($product->quantity > 0): ?>
                                                                <span class="badge rounded-pill"
                                                                    ...
                                                                    <?php echo e($product->quantity); ?></span>
                                                            <?php else: ?>
                                                                <span class="badge rounded-pill"
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($customer->id); ?>" <?php if(old('customer_id') == $customer->id): echo 'selected'; endif; ?>>
                                                    <?php echo e($customer->name); ?><?php if($customer->phone): ?>
...
[$__name, $__params] = $__split('payment.payment-processor', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-62326814-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->startPush('page-scripts'); ?>
    ...
    <script>
        ...
        <div class="receipt-header">
            <div class="company-logo"><?php echo e($shop ? strtoupper(substr($shop->name, 0, 1)) : 'S'); ?></div>
            <div class="company-name"><?php echo e($shop ? $shop->name : 'Shop Name'); ?></div>
            <div class="company-address"><?php echo e($shop ? $shop->address : 'Shop Address'); ?></div>
            <div class="company-address"><?php echo e($shop ? $shop->phone : 'Phone'); ?> | <?php echo e($shop ? $shop->email : 'Email'); ?></div>
        </div>
...
`;
        ...
        function refreshProducts() {
            console.log('Fetching products from:', '<?php echo e(route("orders.products")); ?>');
            fetch('<?php echo e(route("orders.products")); ?>')
                .then(response => {
        ...
        function refreshCustomers() {
            fetch('<?php echo e(route("orders.customers")); ?>')
                .then(response => response.json())
                .then(data => {
        ...
        const warranties = <?php echo json_encode($warranties, 15, 512) ?>;
        ...
        document.addEventListener('livewire:load', function() {
            Livewire.on('payment-completed', function(data) {
                ...
                setTimeout(() => {
                    window.location.href = `<?php echo e(route('orders.show', '')); ?>/${data[0].order_id}`;
                }, 3000);
            });
        });
...
<?php echo $__env->make('layouts.nexora', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\NexoraLabs\resources\views/orders/create.blade.php ENDPATH**/ ?>