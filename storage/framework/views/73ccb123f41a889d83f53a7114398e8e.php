        ...
        <div class="navbar">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('orders.create') ? 'active' : null); ?>">
                    ...
                    <?php if(Auth::user()->hasInventoryAccess()): ?>
                    ...
                    <li class="nav-item dropdown <?php echo e(request()->is('orders*') && !request()->routeIs('orders.create') ? 'active' : null); ?>">
                    ...
                    <li class="nav-item dropdown <?php echo e(request()->is('jobs*') ? 'active' : null); ?>">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo e(route('jobs.index')); ?>">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('jobs.list')); ?>">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('job-letterhead.index')); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z"/></svg>
                                <?php echo e(__('Job Letterhead')); ?>

                            </a>
                            <a class="dropdown-item" href="<?php echo e(route('job-types.index')); ?>">
                    ...
                    <li class="nav-item dropdown <?php echo e(request()->is('reports*') ? 'active' : null); ?>">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a href="<?php echo e(route('reports.sales.index')); ?>" class="dropdown-item">
                                    ...
                                    <a href="<?php echo e(route('reports.sales.daily')); ?>" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <a href="<?php echo e(route('reports.sales.weekly')); ?>" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <rect x="4" y="5" width="16" height="16" rx="2"/>
                                            <line x1="16" y1="3" x2="16" y2="7"/>
                                    ...
                                    <a href="<?php echo e(route('reports.sales.monthly')); ?>" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <rect x="4" y="5" width="16" height="16" rx="2"/>
                                            <line x1="16" y1="3" x2="16" y2="7"/>
                                    ...
                                    <a href="<?php echo e(route('reports.sales.yearly')); ?>" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <rect x="4" y="5" width="16" height="16" rx="2"/>
                                            <line x1="16" y1="3" x2="16" y2="7"/>
                                ...
                                <div class="dropdown-menu-column">
                                    ...
                                    <a href="<?php echo e(route('reports.sales.finance.returns')); ?>" class="dropdown-item">
                                        ...
                                        Returns
                                        <span class="badge bg-secondary ms-2"><?php echo e($navFinanceKpis['returnKpi']->items_returned ?? $navFinanceKpis['returnKpi']->items_returned ?? 0); ?></span>
                                    </a>
                                    <a href="<?php echo e(route('reports.sales.finance.expenses')); ?>" class="dropdown-item">
                                        ...
                                        Expenses
                                        <span class="badge bg-secondary ms-2"><?php echo e(number_format(($navFinanceKpis['expenseKpi']->total_expenses ?? 0) / 100, 2)); ?></span>
                                    </a>
                                    <a href="<?php echo e(route('reports.sales.finance.credit-sales')); ?>" class="dropdown-item">
                                    ...
                                    <a href="<?php echo e(route('reports.sales.finance.customers')); ?>" class="dropdown-item">
                                    ...
                                    <a href="<?php echo e(route('reports.sales.finance.products')); ?>" class="dropdown-item">
                    ...
                    <li class="nav-item dropdown <?php echo e(request()->is('categories*', 'units*') || (Auth::user()->canManageUsers() && request()->is('users*')) ? 'active' : null); ?>">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.shops.index')); ?>">
                                        <?php echo e(__('All Shops')); ?>

                                    </a>
                                    <?php elseif(Auth::user()->hasShop()): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.shops.show', Auth::user()->shop)); ?>">
                                        <?php echo e(__('Shop Details')); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::user()->isShopOwner() || (method_exists(Auth::user(), 'isManagerRole') && Auth::user()->isManagerRole()) || (method_exists(Auth::user(), 'isManager') && Auth::user()->isManager())): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('letterhead.index')); ?>">
                                        <?php echo e(__('Letterhead')); ?>
...
<?php /**PATH C:\xampp\htdocs\New folder\NexoraLabs\resources\views/layouts/body/navbar.blade.php ENDPATH**/ ?>